                ...
                <div class="potolki-item">
                    @foreach($products as $product)
                        <div class="col-lg-4 col-md-4 col-sm-4 float">
                            <a href="/product/{{ $product->id }}" rel="nofollow"><img src=@if($product->id == 4 or $product->id == 5 or $product->id == 6 or $product->id == 15)"{{ $product->image_2 }}"@else"{{ $product->image_1 }}"@endif alt=""></a>
                            <h6><a href="/product/{{ $product->id }}">{{ $product->prod_name }}</a></h6>
                            @isset($product->price)
